...
#
# Created: Thu Aug  1 16:53:05 2013
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.le_infile_2 = QtGui.QLineEdit(self.centralwidget)
        self.le_infile_2.setGeometry(QtCore.QRect(10, 100, 461, 27))
        self.le_infile_2.setText(_fromUtf8(""))
        self.le_infile_2.setPlaceholderText(_fromUtf8("Input File (Ctrl+O)"))
        self.le_infile_2.setObjectName(_fromUtf8("le_infile_2"))
        self.pb_infile_2 = QtGui.QPushButton(self.centralwidget)
        self.pb_infile_2.setGeometry(QtCore.QRect(480, 100, 97, 27))
        self.pb_infile_2.setText(_fromUtf8("Browse"))
        self.pb_infile_2.setShortcut(_fromUtf8("Ctrl+O"))
        self.pb_infile_2.setObjectName(_fromUtf8("pb_infile_2"))
